...
extends k {
    ...
    static {
        ...
        boolean bl = false;
        try {
            Class.forName((String)"org.bouncycastle.jsse.provider.BouncyCastleJsseProvider", (boolean)false, (ClassLoader)a2.getClass().getClassLoader());
            bl = true;
        }
    ...
    public X509TrustManager o() {
        Object object = TrustManagerFactory.getInstance((String)"PKIX", (String)"BCJSSE");
        object.init(null);
