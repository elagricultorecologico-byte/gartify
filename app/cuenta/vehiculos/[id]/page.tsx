      ...
      <div className="bg-white border border-gray-200 overflow-hidden mb-8">
        <div className="bg-gray-50 border-b border-gray-200 px-6 py-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-base font-bold text-gartify-blue">{nombreVehiculo}</h1>
              <p className="text-xs text-gartify-gray mt-0.5">Historial completo de revisiones y sellos de taller</p>
            </div>
          </div>
        </div>
      </div>
