...
import { Car, AlertCircle, Loader2, ArrowLeft } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import { Label } from "@/components/ui/label";

export function LoginConductorForm() {
        ...
        <div className="bg-white border border-gray-200 overflow-hidden">
          ...
          <div className="bg-gray-50 border-b border-gray-200 px-6 py-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-base font-bold text-gartify-blue">Acceso conductor</h1>
                <p className="text-xs text-gartify-gray mt-0.5">Entra para gestionar tus reservas</p>
              </div>
            </div>
          </div>
