const REDES = [
  ...
  // { label: "Facebook", href: "https://www.facebook.com/gartify", svg: null },
  {
    label: "X / Twitter",
    href: "https://x.com/GartifyOfficial",
  ...
  {
    label: "YouTube",
    href: "https://www.youtube.com/@gartifyofficial",
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/gartifyofficial?igsh=MTlmcGZ3ajRjeGZvZQ==",
